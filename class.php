...
<html>
 ...
 <body>
  <div id="header" class="clearfix">
    <h1 style="font-size:28px;">Islamiah Institute of Technology</h1>
    <h3>Edit Class</h3>
  </div>
    ...
    <?php
      ...
      if(!$classes) echo '<h4> You haven\'t taken any classes yet. </h4>';
        ...
        foreach($classes as $class_id) {
          ...
          echo 'Academic : <input class="form-control" name="year" value="'.$year.'" placeholder="Enter Year">';
          echo 'Current Year : <input class="form-control" name="section" value="'.$section.'" placeholder="Enter Section">';
