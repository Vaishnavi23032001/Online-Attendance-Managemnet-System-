   ...
   <!-- Fixed navbar -->
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<a class="navbar-brand" href="index.php" style="font-size:28px;"><br>VIIT, Pune</a><br />
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <ol class="text-left">
            ...
            <li>Click the <button class="btn">A</button> button next to that roll number to mark that student as absent</li>
