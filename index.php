    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
	     ...
	     <a class="navbar-brand" href="index.php" style="font-size:28px;"><br>Vishwakarma Institute of Information Technology, Pune</a><br />
...
<script type="text/javascript">
    ...
    <table class="table table-bordered table-striped">
     ...
     <!-- FOOTER
      <footer style="background:black; height:140%;">
